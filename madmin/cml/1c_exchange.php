		...
		if(isset($category_id))
                {
                    ...
                    if($category_id == 186)
                    {
                        $simpla->categories->add_product_category($product_id, 176);
                    }
                    if($category_id == 191)
                    {
                        $simpla->categories->add_product_category($product_id, 184);
                    }
                    if($category_id == 12)
                    {
                        $simpla->categories->add_product_category($product_id, 95);
                    }
                    if($category_id == 164)
                    {
                        $simpla->categories->add_product_category($product_id, 90);
                    }
                    if($category_id == 96)
                    {
                        $simpla->categories->add_product_category($product_id, 13);
                    }
                    if($category_id == 142)
                    {
                        $simpla->categories->add_product_category($product_id, 2);
                    }
                }
	...
	else
	{
		...
		elseif(empty($variant_id) && empty($variant_1c_id))
		{
			...
			$variant_id = $simpla->db->result('id');		
                ...
                $simpla->products->delete_tags('product', $product_id);
