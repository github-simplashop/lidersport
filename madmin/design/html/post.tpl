{capture name=tabs}
	<li class="active"><a href="{url module=BlogAdmin id=null page=null}">Акции</a></li>
{/capture}
...
<div class="message message_success">
	...
	<a class="link" target="_blank" href="../stock/{$post->url}">Открыть запись на сайте</a>
...
<input type=hidden name="session_id" value="{$smarty.session.id}">
	...
	<div id="column_left">
		...
		<!-- Параметры страницы -->
			<ul>
				<li><label class=property>Адрес</label><div class="page_url"> /stock/</div><input name="url" class="page_url" type="text" value="{$post->url|escape}" /></li>
                ...
                <!--<li><label class=property>Видео</label><input name="video"  type="text" value="{$post->video|escape}" /></li>-->
	...
	<div id="column_right">
		...
		<!-- Изображение записи блога -->	
		<div class="block layer images">

			<h2>Изображение в списке</h2>
			...
			<ul>
				...
				<li>
					...
					<img src="../{$config->stock_images_dir}{$post->image}" alt="" />
					<input type="hidden" name="exist_image" value="{$post->image}">
