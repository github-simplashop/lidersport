{* Вкладки *}
{capture name=tabs}
	<li class="active"><a href="{url module=NewsAdmin page=null keyword=null}">Новости</a></li>
{/capture}
...
<div id="header">
	...
	<h1>Нет записей</h1>
	{/if}
	<a class="add" href="{url module=PostNewsAdmin return=$smarty.server.REQUEST_URI}">Добавить запись</a>
</div>	
	...
	<input type="hidden" name="session_id" value="{$smarty.session.id}">
		...
		<div id="list">
			...
			<div class="{if !$post->visible}invisible{/if} row">
				...
				<div class="name cell">		
					<a href="{url module=PostNewsAdmin id=$post->id return=$smarty.server.REQUEST_URI}">{$post->name|escape}</a>
					<br>
					{$post->date|date}
				</div>
