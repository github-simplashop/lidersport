...
<div id="main">
	...
	<ul id="main_menu"> 
		...
		<li><a href="index.php?module=BlogAdmin"><img src="design/images/menu/blog.png"><b>Акции</b></a></li>
        <!--<li><a href="index.php?module=NewsAdmin"><img src="design/images/menu/blog.png"><b>Новости</b></a></li>-->
		<li>
