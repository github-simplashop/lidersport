...
<ul class="ul_patch pb25" style="margin-left:0">
	<li><a href="/stock">Акции</a></li>
    <li><a class="active" href="#">{$post->name|escape}</a></li>
</ul>
<!-- Заголовок /-->
<p>{$post->date|date}</p>
...
{if $post->video}<br><iframe width="560" height="315" src="http://www.youtube.com/embed/{$post->video}?rel=0" frameborder="0" allowfullscreen></iframe>{/if}
